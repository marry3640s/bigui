...
public:
    ...
    public:
		...
		virtual bool onRMouse(int x, int y, skui::InputState, skui::ModifierKey) { return false; }
        virtual bool onMouseWheel(int x, int y,float delta, skui::ModifierKey) { return false; }
        virtual bool onTouch(intptr_t owner, skui::InputState, float x, float y) { return false; }
		virtual int onIMEMessage(unsigned int nMsg, unsigned int wparam, int lparam) { return false; }
	...
	bool onRMouse(int x, int y, skui::InputState state, skui::ModifierKey modifiers);
    bool onMouseWheel(int x, int y, float delta, skui::ModifierKey modifiers);
    bool onTouch(intptr_t owner, skui::InputState state, float x, float y);  // multi-owner = multi-touch

	int onIMEMessage(unsigned int nMsg, unsigned int wparam, int lparam);
    // Platform-detected gesture events
